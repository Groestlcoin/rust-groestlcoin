...
use groestlcoin::key::{Keypair, TapTweak, TweakedKeypair, UntweakedPublicKey};
use groestlcoin::locktime::absolute;
use groestlcoin::secp256k1::{rand, Message, Secp256k1, SecretKey, Signing, Verification};
use groestlcoin::sighash::{Prevouts, SighashCache, TapSighashType};
use groestlcoin::{
...
fn main() {
    ...
    let signature = groestlcoin::taproot::Signature { sig, hash_ty: sighash_type };
...
fn receivers_address() -> Address {
    Address::from_str("grs1p0dq0tzg2r780hldthn5mrznmpxsxc0jux5f20fwj0z3wqxxk6fpq59lrre")
