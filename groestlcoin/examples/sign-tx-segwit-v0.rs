...
use groestlcoin::secp256k1::{rand, Message, Secp256k1, SecretKey, Signing};
...
fn main() {
    ...
    let signature = groestlcoin::ecdsa::Signature { sig, hash_ty: EcdsaSighashType::All };
...
fn senders_keys<C: Signing>(secp: &Secp256k1<C>) -> (SecretKey, WPubkeyHash) {
    ...
    let pk = groestlcoin::PublicKey::new(sk.public_key(secp));
...
fn receivers_address() -> Address {
    Address::from_str("grs1q7cyrfmck2ffu2ud3rn5l5a8yv6f0chkpjnaczg")
