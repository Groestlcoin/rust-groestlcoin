...
then
    ...
    cargo clippy --locked --example ecdsa-psbt --features=groestlcoinconsensus -- -D warnings
    ...
    cargo clippy --locked --example taproot-psbt --features=rand-std,groestlcoinconsensus -- -D warnings
...
cargo run --locked --example ecdsa-psbt --features=groestlcoinconsensus
...
cargo run --locked --example taproot-psbt --features=rand-std,groestlcoinconsensus
