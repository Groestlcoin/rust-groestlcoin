...
enum LegacyP2pkhPrefix {
    /// Prefix used for legacy addresses on the main Groestlcoin network.
    Mainnet,
...
impl Address {
    ...
    /// Checks whether or not the address is following Groestlcoin standardness rules when
...
mod tests {
    ...
    fn test_p2pkh_address_58() {
        ...
        let addr = Address::p2pkh(hash, Groestlcoin);
    ...
    fn test_p2sh_address_58() {
        ...
        let addr = Address::p2sh_from_hash(hash, Groestlcoin);
    ...
    fn test_p2wpkh() {
        ...
        assert_eq!(Address::p2wpkh(&key, Groestlcoin).unwrap_err(), UncompressedPubkeyError);
    }
    ...
    fn p2tr_from_untweaked() {
        ...
        roundtrips(&address, Groestlcoin);
    }
