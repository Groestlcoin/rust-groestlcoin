...
//!
//! Relies on the `groestlcoinconsensus` crate that uses Groestlcoin Core libconsensus to perform validation.
...
/// [`groestlcoinconsensus::VERIFY_ALL`].
///
/// # Parameters
...
///
/// [`groestlcoinconsensus::VERIFY_ALL`]: https://docs.rs/bitcoinconsensus/0.20.2-0.5.0/bitcoinconsensus/constant.VERIFY_ALL.html
...
{
    verify_transaction_with_flags(tx, spent, groestlcoinconsensus::VERIFY_ALL)
}
