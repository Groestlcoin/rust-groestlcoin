...
/// Groestlcoin block version number.
///
/// Originally used as a protocol version, but repurposed for soft-fork signaling.
///
/// The inner value is a signed integer in Groestlcoin Core for historical reasons, if version bits is
...
impl Version {
    /// The original Groestlcoin Block v1.
    pub const ONE: Self = Self(112);
...
mod tests {
    ...
    fn block_test() {
        ...
        let prevhash = hex!("54e62863a89f1c737a8c9647c3843d16bcfd81c9b0048653b459df0200000000");
        let merkle = hex!("755988c47b18539187e9d050453781266ddd193820e94c72eff0b7562185f525");
        let work = Work::from(0x5228d4deda_u128);
        ...
        assert_eq!(real_decode.header.version, Version(112));
        assert_eq!(serialize(&real_decode.header.prev_blockhash), prevhash);
        assert_eq!(real_decode.header.merkle_root, real_decode.compute_merkle_root().unwrap());
        assert_eq!(serialize(&real_decode.header.merkle_root), merkle);
        assert_eq!(real_decode.header.time, 1396708728);
        assert_eq!(real_decode.header.bits, CompactTarget::from_consensus(0x1c031dab));
    ...
    fn segwit_block_test() {
        ...
        let prevhash = hex!("51f4bcc013edd897566497e64c35735d4320f52e4c64b59a4007000000000000");
        let merkle = hex!("163c9ba874a3e94426b379e769bdfd4df93117114c14d14111dd7f1aa0a375c9");
        let work = Work::from(0x6b9fa222841d9_u64);
        ...
        assert_eq!(real_decode.header.bits, CompactTarget::from_consensus(0x1a260eff));
        ...
        assert_eq!(real_decode.stripped_size(), Weight::from_wu(385));
        assert_eq!(real_decode.weight(), Weight::from_wu(1685));
    ...
    fn validate_pow_test() {
        let some_header = hex!("7000000054e62863a89f1c737a8c9647c3843d16bcfd81c9b0048653b459df0200000000755988c47b18539187e9d050453781266ddd193820e94c72eff0b7562185f52578154053ab1d031c18d13500");
