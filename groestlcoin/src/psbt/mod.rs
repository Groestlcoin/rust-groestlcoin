...
mod tests {
            ...
            unsigned_tx: Transaction {
                ...
                input: vec![TxIn {
                    previous_output: OutPoint {
                        txid: "c18ae00954e21fe8a5876b5f11e56774cd10836c6b56c5c563b6348874fddf57"
                            .parse()
                            .unwrap(),
                        vout: 0,
                    },
    ...
    mod bip_vectors {
        ...
        #[test]
        fn valid_vector_3() {
            let psbt: Psbt = hex_psbt!("").unwrap();
        ...
        #[test]
        fn valid_vector_4() {
            let psbt: Psbt = hex_psbt!("").unwrap();
        ...
        let mut unserialized = Psbt {
            unsigned_tx: Transaction {
                ...
                input: vec![
                    TxIn {
                        previous_output: OutPoint {
                            txid: "c18ae00954e21fe8a5876b5f11e56774cd10836c6b56c5c563b6348874fddf57".parse().unwrap(),
                            vout: 0,
                        },
                        script_sig: ScriptBuf::new(),
                        sequence: Sequence::ENABLE_LOCKTIME_NO_RBF,
