...
impl Target {
    ...
    pub const MAX_ATTAINABLE_MAINNET: Self = Target(U256(0x0FFF_FFFF_FFFF_u128 << (208 - 128), 0));
    ...
    pub const MAX_ATTAINABLE_REGTEST: Self = Target(U256(0x00FF_FFFF_FFFF_FFFF_u128 << 96, 0));
    ...
    pub const MAX_ATTAINABLE_SIGNET: Self = Target(U256(0x0377_ae00_u128 << 80, 0));
