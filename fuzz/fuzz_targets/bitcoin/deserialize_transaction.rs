<<<<<<<< HEAD:groestlcoin/fuzz/fuzz_targets/deserialize_transaction.rs
...
>>>>>>>> upstream/master:fuzz/fuzz_targets/bitcoin/deserialize_transaction.rs
    match tx_result {
        Err(_) => {}
        Ok(mut tx) => {
            ...
            for input in &mut tx.input {
                input.witness = groestlcoin::blockdata::witness::Witness::default();
            }
